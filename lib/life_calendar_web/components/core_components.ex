defmodule LifeCalendarWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LifeCalendarWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LifeCalendarWeb.Gettext, "errors", msg, opts)
    end
  end
